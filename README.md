...
- **h**ead of an event is a verbal form; here, the event initiator role is denoted as head with the event category and position of the event verb the initiator token refers to.
