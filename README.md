...
- **h**ead of an event is a verbal form, here head is the event initiator labelled with the event category and position of the event verb the head initiator token refers to.
