...
- **h**ead of an event is a verbal form; here, it's the event initiator to be denoted as head, along with the event *type* and position (subscript) of the event verb the initiator refers to.
