...
```
**NOTE**: we have tried hard, but there is no easy way to ship the installation of conda across operating systems and users, therefore this step is a necessary manual operation to do. Advanced users may also proceed to the custome installation of their python and requirements.txt
