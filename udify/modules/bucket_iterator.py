...
def group_by_data_type(instances: List[Instance]) -> List[Instance]:
    d = defaultdict(list)
...
class BucketIterator(DataIterator):
    ...
    sorting_keys : List[Tuple[str, str]]
        ...
        "num_token_characters" of the "sentence1" field.  TODO(): we should have some
    ...
    def _create_batches(self, instances: Iterable[Instance], shuffle: bool) -> Iterable[Batch]:
        instances_by_data = group_by_data_type(instances)
        all_batches = []
